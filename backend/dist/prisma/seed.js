...
async function main() {
    ...
    await Promise.all(doctors.flatMap((doctor, index) => [1, 2, 3, 4, 5].map((day) => prisma.doctorSchedule.create({
        data: {
            doctorId: doctor.id,
            dayOfWeek: day,
    ...
    const appointments = await Promise.all([
        prisma.appointment.create({
            data: {
                ...
                startTime: '10:00',
                endTime: '10:30',
                status: client_1.AppointmentStatus.PLANNED,
